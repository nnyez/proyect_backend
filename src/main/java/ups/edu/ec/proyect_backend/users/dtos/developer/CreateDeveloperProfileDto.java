...
/**
 * DTO para creación de perfil de usuario DEVELOPER/ADMIN
 * Campos completos: photoUrl, phoneNumber, title, bio, experienceYears, skills
 */
public class CreateDeveloperProfileDto {
    ...
    // ============ CONSTRUCTORS ============
    public CreateDeveloperProfileDto() {
    }

    public CreateDeveloperProfileDto(String photoUrl, String phoneNumber, String title, String bio,
