...
/**
 * DTO para actualización (PUT) de perfil de usuario DEVELOPER/ADMIN
 * Campos completos: todos requeridos para PUT
 */
public class UpdateDeveloperProfileDto {
    ...
    // ============ CONSTRUCTORS ============
    public UpdateDeveloperProfileDto() {
    }

    public UpdateDeveloperProfileDto(String photoUrl, String phoneNumber, String title, String bio,
